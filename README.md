...
1. 💪 Opened PR [#62](https://github.com/wolfi-dev/tools/pull/62) in [wolfi-dev/tools](https://github.com/wolfi-dev/tools)
2. 💪 Opened PR [#5892](https://github.com/wolfi-dev/os/pull/5892) in [wolfi-dev/os](https://github.com/wolfi-dev/os)
3. 🎉 Merged PR [#2](https://github.com/goreleaser/goreleaser-example-slsa-provenance/pull/2) in [goreleaser/goreleaser-example-slsa-provenance](https://github.com/goreleaser/goreleaser-example-slsa-provenance)
4. 💪 Opened PR [#5740](https://github.com/wolfi-dev/os/pull/5740) in [wolfi-dev/os](https://github.com/wolfi-dev/os)
5. ❗ Opened issue [#693](https://github.com/chainguard-dev/melange/issues/693) in [chainguard-dev/melange](https://github.com/chainguard-dev/melange)
