...
1. ❗️ Opened issue [#593](https://github.com/rancher/k3d/issues/593) in [rancher/k3d](https://github.com/rancher/k3d)
2. 🎉 Merged PR [#2](https://github.com/developer-guy/kubernetes-response-engine-based-on-event-driven-workflow/pull/2) in [developer-guy/kubernetes-response-engine-based-on-event-driven-workflow](https://github.com/developer-guy/kubernetes-response-engine-based-on-event-driven-workflow)
