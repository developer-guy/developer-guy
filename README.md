...
1. 💪 Opened PR [#6016](https://github.com/wolfi-dev/os/pull/6016) in [wolfi-dev/os](https://github.com/wolfi-dev/os)
2. 💪 Opened PR [#62](https://github.com/wolfi-dev/tools/pull/62) in [wolfi-dev/tools](https://github.com/wolfi-dev/tools)
3. 💪 Opened PR [#5892](https://github.com/wolfi-dev/os/pull/5892) in [wolfi-dev/os](https://github.com/wolfi-dev/os)
4. 🎉 Merged PR [#2](https://github.com/goreleaser/goreleaser-example-slsa-provenance/pull/2) in [goreleaser/goreleaser-example-slsa-provenance](https://github.com/goreleaser/goreleaser-example-slsa-provenance)
5. 💪 Opened PR [#5740](https://github.com/wolfi-dev/os/pull/5740) in [wolfi-dev/os](https://github.com/wolfi-dev/os)
